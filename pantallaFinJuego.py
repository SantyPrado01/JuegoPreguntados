...
def findeljuego(nombre, tiempo, preguntas):
    ...
    agradecimineto_label = Label(ventana_gracias_jugar, text=f'Gracias {nombre} por jugar', font=('Roboto', 25))
    agradecimineto_label.grid(row=0, column=0, columnspan=2, padx=10, pady=10)

    resultado_label = Label(ventana_gracias_jugar, text='Resultado de tu partida', font=('Roboto', 20))
    resultado_label.grid(row=1, column=0, columnspan=2, padx=10, pady=10)
    
    resultado_preguntas = Label(ventana_gracias_jugar, text= f'De 15 preguntas respondiste {preguntas}', font=('Roboto', 20))
    resultado_preguntas.grid(row=2, column=0, columnspan=2, padx=10, pady=10)

    if preguntas >= 15:
        devolucion_label = Label(ventana_gracias_jugar, text='Sos un genio, no tuviste ningun error!', font=('Roboto', 20))
        devolucion_label.grid(row=3, column=0, columnspan=2, padx=10, pady=10)
    elif preguntas >=12:
        devolucion_label = Label(ventana_gracias_jugar, text='Estas Promocionado, segui asi', font=('Roboto', 20))
        devolucion_label.grid(row=3, column=0, columnspan=2, padx=10, pady=10)
    elif preguntas >=10:
        devolucion_label = Label(ventana_gracias_jugar, text='Un glorioso cuatro!', font=('Roboto', 20))
        devolucion_label.grid(row=3, column=0, columnspan=2, padx=10, pady=10)
    else:
        devolucion_label = Label(ventana_gracias_jugar, text='Nos veremos en diciembre!', font=('Roboto', 20))
        devolucion_label.grid(row=3, column=0, columnspan=2, padx=10, pady=10)

    resultado_tiempo = Label(ventana_gracias_jugar, text=f'Y tu tiempo para responder fue de: {tiempo} segundos', font=('Roboto', 20))
    resultado_tiempo.grid(row=4, column=0, columnspan=2, padx=10, pady=10)

    red_social_label = Label(ventana_gracias_jugar, text='Dejanos tu Instagram para contactarte! ', font=('Roboto', 20))
    ...
    numero_telefono_label = Label(ventana_gracias_jugar, text='O dejanos tu numero: ', font=('Roboto', 20))
